...
namespace TutorialSystem.Editor
{
    ...
    /// ArrowModule专属Drawer
    /// </summary>
    [CustomPropertyDrawer(typeof(ArrowModule))]
    public class ArrowModuleDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            if (foldout)
            {
                ...
                // Arrow Properties
                yOffset = DrawHeader(position, yOffset, "Arrow Properties");
                yOffset = DrawPropertyField(position, property, "direction", "Direction", yOffset);
        ...
        public override float GetPropertyHeight(SerializedProperty property, GUIContent label)
        {
            ...
            // Arrow Properties header
            height += EditorGUIUtility.singleLineHeight + 4;
            height += GetPropertyHeight(property, "direction");
